...
const (
	...
	CategoryService_UpdateCategorySteamBidirectional_FullMethodName  = "/pb.CategoryService/UpdateCategorySteamBidirectional"
)
...
type CategoryServiceClient interface {
	...
	UpdateCategorySteamBidirectional(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[UpdateCategoryRequest, Category], error)
}
...
func (c *categoryServiceClient) UpdateCategorySteamBidirectional(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[UpdateCategoryRequest, Category], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[2], CategoryService_UpdateCategorySteamBidirectional_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[UpdateCategoryRequest, Category]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_UpdateCategorySteamBidirectionalClient = grpc.BidiStreamingClient[UpdateCategoryRequest, Category]
...
type CategoryServiceServer interface {
	...
	UpdateCategorySteamBidirectional(grpc.BidiStreamingServer[UpdateCategoryRequest, Category]) error
...
func (UnimplementedCategoryServiceServer) UpdateCategorySteamBidirectional(grpc.BidiStreamingServer[UpdateCategoryRequest, Category]) error {
	return status.Errorf(codes.Unimplemented, "method UpdateCategorySteamBidirectional not implemented")
}
...
func _CategoryService_UpdateCategorySteamBidirectional_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).UpdateCategorySteamBidirectional(&grpc.GenericServerStream[UpdateCategoryRequest, Category]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type CategoryService_UpdateCategorySteamBidirectionalServer = grpc.BidiStreamingServer[UpdateCategoryRequest, Category]
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "UpdateCategorySteamBidirectional",
			Handler:       _CategoryService_UpdateCategorySteamBidirectional_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
